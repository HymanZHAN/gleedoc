...
pub fn filter_unused_imports_keeps_qualified_module_test() {
  let src =
  ...
  let result = scan.filter_unused_imports(src)
...
pub fn filter_unused_imports_keeps_unqualified_value_test() {
  let src =
...
pub fn filter_unused_imports_keeps_pattern_constructor_test() {
  let src =
...
pub fn filter_unused_imports_drops_entire_unused_module_test() {
  let src =
    "import gleam/result\n"
    <> "import gleam/string\n"
    <> "\n"
...
pub fn filter_unused_imports_preserves_header_test() {
  let src =
    "// Generated by gleedoc - do not edit manually\n"
    <> "\n"
    <> "import gleam/string\n"
  ...
  assert string.starts_with(result, "// Generated by gleedoc - do not edit manually")
  assert !string.contains(result, "import gleam/string")
}
...
pub fn filter_unused_imports_bear_fixture_test() {
